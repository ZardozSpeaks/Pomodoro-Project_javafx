package com.davidremington.pomodoro.controllers;

import com.davidremington.pomodoro.models.Attempt;
import com.davidremington.pomodoro.models.AttemptKind;
...
public class Home {
    ...
    public Home() {
        ...
        setTimerText(0);
        mApplause = new AudioClip(getClass().getResource("/sounds/applause10.mp3").toExternalForm());
    }
